<aside class="w-64 bg-gray-800 text-white fixed h-full transition-all duration-300" id="sidebar">
    ...
    <nav>
        <a href="/dashboard" class="flex items-center px-4 py-3 hover:bg-gray-700 gap-x-3">
        ...
        <a href="/profile" class="flex items-center px-4 py-3 hover:bg-gray-700 gap-x-3">
        ...
        <a href="/keranjang" class="flex items-center px-4 py-3 hover:bg-gray-700 gap-x-3">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="w-8 h-8">
        ...
        <a href="/cetak" class="flex items-center px-4 py-3 hover:bg-gray-700 gap-x-3">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="w-8 h-8">
                ...
                <span class="text-white text-lg">Cetak Bukti Bayar</span>
            </a>

        <a href="/settings" class="flex items-center px-4 py-3 hover:bg-gray-700 gap-x-3">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="w-8 h-8">
        ...
        <a href="/lapor" class="flex items-center px-4 py-3 hover:bg-gray-700 gap-x-3">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="w-8 h-8">
